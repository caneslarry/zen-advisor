...
class ProfileViewController: UIViewController, SendMessageDelegate{
    ...
    func loadProfileEdit(_ sender: UIBarButtonItem) {
    ...
    func returnmsg(_ msg:String){
        ...
        if(msg == "register") {
            self.title = "Register"
            self.loadComponent("ComponentRegister")
        } else if(msg == "login") {
            self.title = "Login"
            self.loadComponent("ComponentLogin")
        } else if(msg == "forgot") {
            self.title = "Forgot Password"
            self.loadComponent("ComponentForgot")
        } else if(msg == "profile") {
            self.title = "Profile"
            self.loadComponent("ComponentUserProfile")
